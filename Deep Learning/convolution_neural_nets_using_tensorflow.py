...
"""     The labels are stored in a simple file as a string of bytes. There is a header consisting
        of 8 bytes, with the remainder of the data containing labels. 
        This function extracts labels from the downloaded dataset into an array of
        labels """
